...
window.addEventListener('DOMContentLoaded', function(event) {  
	...
	$('[data-modal=consultation], #index__menu_btn , #index__services_add, #check__order').on('click', function() {
...
$("#check__on__site").on('click', function() {
	...
	day = today.toISOString().substr(8,2);
	month = today.toISOString().substr(5,2);
	today.setDate(today.getDate() + 15); 
	nextDay = today.toISOString().substr(8,2);
	nextMonth = today.toISOString().substr(5,2);
	...
	{
		$wrapperClick = $(".popular__wrapper_" + $i);
		$cityLink="//tp.media/r?trace_id=Zz89897ec7fbdf4c9ba398bc46f65149&p=4044&marker=292335.Zz89897ec7fbdf4c9ba398bc46f65149.$1489.$11&u=%2F%2Ftravel.mekenavia.ru%2Fflights%2F" + cities[$i-1][0] +day+month+cities[$i-1][1] +nextDay + nextMonth + "1%3Fmarker%3D292335.Zz89897ec7fbdf4c9ba398bc46f65149.%241489.%2411%26locale%3Dru%26currency%3Drub";
		$wrapperClick.attr('onclick',"window.location=\'" + $cityLink + "\'");
	}

});
//angry card 
if(document.title == "Сервисы и покупки"){
}
